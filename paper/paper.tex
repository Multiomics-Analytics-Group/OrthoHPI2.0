...
stage by stage and separately for each host--parasite pair.
...
\begin{figure}[p]
  ...
  the taxonomic group (inner). The DeepLoc filter leaves an intracellular
  parasite roughly five times as many host proteins as an extracellular one.
  \todo{per-pair counts in Supplementary Table SX}}
  \label{fig:funnel}
\end{figure}
